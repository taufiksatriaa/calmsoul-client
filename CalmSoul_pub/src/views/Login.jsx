  ...
  return (
    <>
      <section className="min-h-screen flex items-stretch text-white ">
        <div
          className="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center opacity-70"
          style={{
            backgroundImage:
        ...
        >
          ...
          <div className="w-full px-24 z-10">
            ...
            <p className="text-3xl my-4">Every moment is precious.</p>
          </div>
        ...
        <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0 bg-gradient-to-r from-slate-300 to-slate-500">
